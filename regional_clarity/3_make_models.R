...
xgb.save(xgb1, "modeling/regional_clarity/xg_models/prelim/xgb1_noNW.model")
xgb2 <- xgb.train(params = params, data = dtrain2, nrounds = 2000, 
                  watchlist = list(train = dtrain2, val = dval2), 
                  verbose = 1,
                  early_stopping_rounds = 50)
xgb.save(xgb2, "modeling/regional_clarity/xg_models/prelim/xgb2_noNW.model")
xgb3 <- xgb.train(params = params, data = dtrain3, nrounds = 2000, 
                  watchlist = list(train = dtrain3, val = dval3), 
                  verbose = 1,
                  early_stopping_rounds = 50)
xgb.save(xgb3, "modeling/regional_clarity/xg_models/prelim/xgb3_noNW.model")
xgb4 <- xgb.train(params = params, data = dtrain4, nrounds = 2000, 
                  watchlist = list(train = dtrain4, val = dval4), 
                  verbose = 1,
                  early_stopping_rounds = 50)
xgb.save(xgb4, "modeling/regional_clarity/xg_models/prelim/xgb4_noNW.model")
