...
how much of the prediction now comes from site characteristics vs.
optical, and does that change per model?
"""
import json
...
FEATURE_SETS = {
    ...
    "joint18": ["atm_corr_LaSRC", "red_corr7", "nir_corr7", "swir1_corr7", "temp_corr7",
                "BR", "BG", "NR", "fai", "NDVI", "NDSSI", "NDWI", "MNDWI",
                "catchment_area_sqkm", "pct_urban_2006", "pct_forest_2006",
